        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfitKf = table.Column<float>(nullable: false),
                    DeliveryWay = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Calority = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RealizationPlaces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RealizationPlaces_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "meister", "25D55AD283AA400AF464C76D713C07AD", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RealizationPlaces_CityId",
